...
{image && (
  <div className="flex gap-3 p-3 rounded-xl bg-blue-500/5 border border-blue-500/20">
    ...
    <p className="text-xs text-blue-300 leading-relaxed">
      <strong>Best results with dermoscopy images.</strong> Models were trained on 
      dermoscopic images taken with a dermatoscope. Regular phone camera photos 
      may give unreliable predictions.
    </p>
  </div>
)}
